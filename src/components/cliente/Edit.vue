        ...
        <div v-if="currentJogador" class="edit-form">
            ...
            <form>
                ...
                <div class="form-group">
                    ...
                    <input type="text" v-model="cliente.endereco.username" class="form-control" id="inputUsername">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="date" v-model="cliente.endereco.DataUltimoLogin" class="form-control"
