            ...
            <table class="table table-striped" >
                ...
                <tbody>
                    <tr v-for="(p, indice) in perfis" :key ="p.id" :class="{ active: indice == currentIndex }">
                            <td>{{p.id}}</td>
                            <td>{{p.descricao}}</td>
                            <td><button v-on:click="setCurrentPerfil(p, indice)" class="btn" type="button">Alterar</button></td>
                            <td><button v-on:click="remPerfil(p, indice)" class="btn" type="button">Remover</button></td>
                    </tr>
                </tbody>
            </table>
