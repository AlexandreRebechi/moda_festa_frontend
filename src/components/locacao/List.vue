    ...
    <div id="tab_aut">
            ...
            <table class="table table-striped" >
                ...
                <tbody>
                    <tr v-for="(l, indice) in locacao" :key ="l.id" :class="{ active: indice == currentIndex }">
                            ...
                            <td><button v-on:click="setCurrentLocacao(l, indice)" class="btn" type="button">Alterar</button></td>
                            <td><button v-on:click="remLocacao(l, indice)" class="btn" type="button">Remover</button></td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="col-md-6">
            <div v-if="currentLocacao">
                    ...
                    :href="'/locacao/' + currentLocacao.id"
                    >
                    Edit
                    </a>
            </div>
